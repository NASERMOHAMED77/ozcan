...
import 'package:flutter_almirtech_ecommerce/features/address/views/saved_address_list_screen.dart';
import 'package:flutter_almirtech_ecommerce/features/address/views/saved_billing_address_list_screen.dart';
              ...
              builder: (context, locationProvider, _) {
                return Container(padding: const EdgeInsets.fromLTRB(
                    ...
                    MaterialPageRoute(builder: (
                        BuildContext context) => const SavedAddressListScreen())),

                child: Card(child: Container(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                ...
                SizedBox(width: 20, child: Image.asset(Images.edit, scale: 3, color: Theme.of(context).primaryColor,)),]),
                ...
                AddressInfoItem(icon: Images.address, title: locationProvider.addressList![shippingProvider.addressIndex!].address??''),])])]))),
                ): const SizedBox(),
